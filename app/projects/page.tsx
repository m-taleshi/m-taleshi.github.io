          ...
          <div className="projects-grid">
            ...
            <div className="card">
              ...
              <div className="card-content">
                ...
                <p>
                  Advised BSc and MSc students on experimental design and data collection methods, contributed to coding
                  machine learning algorithms, assisted in developing the GUI using PyQt for real-time data acquisition
                  and analysis, and worked on improving prosthetic hand control systems.
                </p>
                <div className="tags">
                  <span className="tag">Python</span>
            ...
            <div className="card">
              ...
              <div className="card-content">
                ...
                <p>
                  Contributed to experimental design, participated in data collection, analyzed EMG, kinematic, and MEG
                  data, and worked on identifying correlations between muscle activity, brain dynamics, and handwriting
                  performance.
                </p>
                <div className="tags">
